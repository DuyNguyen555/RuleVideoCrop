...
def main():
    ...
    writer.writerow(["frame", "read_ms", "proc_ms", "total_ms"])
    ...
    while cap.isOpened():
        ...
        pipe.process_frame(frame, kernel, frame_index)
    ...
    realtime_factor = (fps * elapsed_total_s) / max(1, total_frames)  # >1  chậm hơn realtime
